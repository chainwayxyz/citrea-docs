...
Since Citrea is an EVM-compatible ZK-rollup on Bitcoin, you need an EVM-compatible wallet in installed in your system or browser.
...
In this tutorial, we will briefly go over installing Metamask, the most popular EVM wallet to a browser. Using Metamask, you can interact with Citrea Devnet quite easily.
...
### Select operating system/browser and click download

Here, we will go through the most common setup - installing on Chrome. However, most of the steps are the same after downloading the extension/app.
