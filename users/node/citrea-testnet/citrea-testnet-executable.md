...
```sh
chmod u+x ./citrea-v0.6.4-osx-arm64
```

```sh
chmod u+x ./citrea-v0.6.4-linux-amd64
```
...
Mac:
```sh
./citrea-v0.6.4-osx-arm64 --da-layer bitcoin --rollup-config-path ./rollup_config.toml --genesis-paths ./genesis
```

Linux:
```sh
./citrea-v0.6.4-linux-amd64 --da-layer bitcoin --rollup-config-path ./rollup_config.toml --genesis-paths ./genesis
```
