...
{% hint style="info" %}
Citrea is EVM compatible, so you can add Citrea Testnet to any EVM wallet with the content available at the [chain information](https://docs.citrea.xyz/developer-documentation/chain-information) section.
{% endhint %}
