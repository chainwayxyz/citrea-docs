...
```sh
chmod u+x ./citrea-v1.1.0-osx-arm64
```
...
If you do not want to use the provided binary executable to setup a Citrea node, you can also build it from the source code [here](https://docs.citrea.xyz/developer-documentation/run-a-node/citrea-testnet/citrea-testnet-source).
